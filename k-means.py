...
def calculate_distances(point, centroids):
    ...
    Returns:
    - distances (numpy.ndarray): A numpy array containing the Euclidean distances between
    ...
    The Euclidean distance between two points in n-dimensional space is defined as the square root of the sum of
    the squared differences between the corresponding coordinates of the points.
    """
